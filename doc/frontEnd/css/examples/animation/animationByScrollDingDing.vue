...
const contenter = useTemplateRef('contenter')
//***********第四步看这里
...
onMounted(() => {
    ...
    function updateAnimationMap() {
        ...
        console.log(playGroundRect, scrollY, playGroundTop, playGroundBottom)
    ...
    contenter.value!.addEventListener('scroll', updateStyles);
})
