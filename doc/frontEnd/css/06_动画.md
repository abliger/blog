...
:::demo src=frontEnd/css/examples/animation/animationByScroll.vue
:::

### 使用 animation-timeline

safari 暂不支持 // todo

:::demo src=frontEnd/css/examples/animation/animationByScrollOnlyCss.vue
:::

### [钉钉官网滚动条动画](https://www.bilibili.com/video/BV1C64y1H7VE/?spm_id_from=333.337.search-card.all.click&vd_source=bc71040cbd0ab8bf4bed58186b3e6954)

:::demo src=frontEnd/css/examples/animation/animationByScrollDingDing.vue
:::
