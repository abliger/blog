...
- [TCP 网络编程](#TCP网络编程)
  ...
  - [开发步骤](#开发步骤)
    ...
    - [2、客户端](#2客户端)
  - [相关 API](#相关API)
  - [示例一：单个客户端与服务器单次通信](#示例一单个客户端与服务器单次通信)
    - [客户端示例代码](#客户端示例代码)
    - [服务器端示例代码](#服务器端示例代码)
  - [示例二：多个客户端与服务器之间的多次通信](#示例二多个客户端与服务器之间的多次通信)
    - [客户端示例代码](#客户端示例代码)
    - [服务器端示例代码](#服务器端示例代码)
- [UDP 网络编程](#UDP网络编程)
  - [相关 API](#相关API)
...
[网络通信协议](网络通信协议/网络通信协议.md "网络通信协议")

[网络编程三要素](网络编程三要素/网络编程三要素.md "网络编程三要素")
...
- 域名(hostName)：[www.atguigu.com](http://www.atguigu.com "www.atguigu.com")
- IP 地址(hostAddress)：202.108.35.210

lInetAddress 类没有提供公共的构造器，而是提供 了 如下几个 静态方法来获取 InetAddress 实例
...
![](image/1564024229499_HUef-v9WIA.png)

## Socket

通信的两端都要有 Socket（也可以叫"套接字“），是两台机器间通信的端点。网络通信其实就是 Socket 间的通信。Socket 可以分为：
...
\<img src="imgs/1564024229499.png" alt="1564024229499" style="zoom:200%;" />
...
![](image/1564024229499_fVuf7OHJJI.png)
...
![](image/1564027041074_blonD6hf81.png)
