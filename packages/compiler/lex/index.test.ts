...
describe("lex test", () => {
    ...
    test("number test", () => {
        ...
        expect(lex("0b101010")).toEqual([
            { type: "number", value: "0b101010" },
        ])
        expect(lex("0o123456")).toEqual([
            { type: "number", value: "0o123456" },
        ])
        expect(lex("0x123456")).toEqual([
            { type: "number", value: "0x123456" },
        ])
